...
METADATA = {
    "name": "Active security scanner",
    "description": """
        Verification of security properties of network endpoints at given IP and port ranges
...
def prepare_metadata_active_scanner(protocol):
    ...
    return {
        "name": "Active security scanner for " + protocol + " protocol",
        "description": (
