#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Metasploit wrapper for cotopaxi.service_ping."""
#
...
try:
    ...
    from cotopaxi.service_ping import main
...
METADATA = {
    "name": (
        "Tool for checking availability of network protocol endpoints "
        "at given IP and port ranges "
        "(wrapper for cotopaxi.service_ping)"
    ),
    "description": (
        " Checks availability of  server "
...
def prepare_metadata_ping(protocol):
