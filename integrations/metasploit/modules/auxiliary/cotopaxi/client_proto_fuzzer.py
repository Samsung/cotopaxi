...
METADATA = {
    "name": "Black-box fuzzer for testing protocol clients",
    "description": """
        ...
        (wrapper for cotopaxi.client_proto_fuzzer)
    """,
    "authors": ["Jakub Botwicz"],
    "date": "2021-04-07",
    "license": "GPL_LICENSE",
...
def prepare_metadata(protocol):
    ...
    return {
        "name": "Client fuzzer for " + protocol + " protocol",
        "description": (
            " Fuzz " + protocol + " server "
